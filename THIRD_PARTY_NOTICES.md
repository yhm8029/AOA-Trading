...
The `louisnw01/lightweight-charts-python` README was consulted for UX patterns. No source from that wrapper is copied or distributed as part of this app.

Original AOA/BitMEX execution data and Binance datasets are **not included** in this source repository. The project's code license does not grant rights over those external datasets. Users import their authorized local data.
