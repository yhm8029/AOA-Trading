...
export function renderStudy(root,data,onEvidence){
  ...
  const ftitle=el('h4','관측 사실');root.append(ftitle);
  ...
  if(e.counter_evidence.length){root.append(el('h4','이번 거래에서 단정하면 안 되는 이유'));for(const t of e.counter_evidence)root.append(el('p',t,'counter'));}
