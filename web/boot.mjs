...
import {UI_VERSION} from './study-ui.mjs?v=031';
const style=document.createElement('link');style.rel='stylesheet';style.href='/launch.css?v=031';document.head.append(style);
...
try {
  ...
  // The launcher verifies the full release manifest on disk as well.
